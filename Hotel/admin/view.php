...
$jsonData= getJSONFromDB("SELECT * FROM `booking` JOIN `user_info` ON booking.uid=user_info.Email");
...
for($i=0;$i<sizeof($jsn);$i++){
	...
	//if($jsn[$i]->type==$type && $jsn[$i]->status=="nb"){
	    ...
	    echo"<tr>";
		echo "<td>".$jsn[$i]->First_Name."</td>";
		echo "<td>".$jsn[$i]->Last_Name."</td>";
		echo "<td>".$jsn[$i]->Gender."</td>";
		echo "<td>".$jsn[$i]->Email."</td>";
		echo "<td>".$jsn[$i]->rid."</td>";
		echo "<td>".$jsn[$i]->rtype."</td>";
		echo "<td>".$jsn[$i]->cdate."/".$jsn[$i]->cmonth."/".$jsn[$i]->cyear."</td>";
		echo "<td>".$jsn[$i]->codate."/".$jsn[$i]->comonth."/".$jsn[$i]->coyear."</td>";
